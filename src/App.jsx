...
const STORIES_DATA = [
  ...
  {
    id: 11,
    title: "รับสมัครความเหงา",
    subtitle: "ป้ายประกาศที่หลายคนคงโทรไปหา",
    location: "ถนนเพชรบุรี กรุงเทพฯ",
    date: "02.02.2026",
    image: "/img/15.jpg", 
    fact: "ถนนเพชรบุรี กรุงเทพฯ",
    fiction: "ตู๊ด ตู๊ด ตู๊ด สวัสดีครับ จากฝ่ายกระจายความเหงา หากต้องการความเหงาเพิ่มเติม กรุณาส่งเสียงสัญญาให้เราทราบว่าตอนนี้คุณโอเคกับมันอยู่จริงๆ หากต้องการเพิ่มเติม กรุณากด 1 หากต้องการลดความเหงา กรุณากด 2 หากต้องการยกเลิกความเหงา กรุณากด 3 ขอบคุณที่ใช้บริการกระจายความเหงาของเรา ขอให้มีความเหงาที่ดีนะครับ",
    mood: "ISOLATION"
  },
  {
    id: 12,
    title: "ไฟเขียวได้หรือยัง?",
    subtitle: "ป้ายจราจรที่แดงนำหน้าเสมอ",
    location: "ถนนเพชรบุรี กรุงเทพฯ",
    date: "02.02.2026",
    image: "/img/16.jpg", 
    fact: "ป้ายจราจร ถนนเพชรบุรี กรุงเทพฯ",
    fiction: "ฉันรอไฟเขียวมานานแล้วนะ ติดไฟแดงมาสักพักแล้ว ไปต่อได้หรือยัง? อย่างน้อยช่วยขึ้นเลขให้เห็นด้วยได้ไหม บางครั้งฉันตั้งใจรอเกินไป บางครั้งฉันเหม่อมองแมวข้างทางจนพลาดไฟเขียวไป แต่ฉันรอนะ คิดว่าคงจะเขียวในอีกไม่นานนี้แหละ",
    mood: "ISOLATION"
  },
  {
    id: 13,
    title: "เขียวแล้วนะ",
    subtitle: "อย่าลืมข้ามถนนนะ",
    location: "ถนนเพชรบุรี กรุงเทพฯ",
    date: "02.02.2026",
    image: "/img/17.jpg", 
    fact: "ไฟเขียว ถนนเพชรบุรี กรุงเทพฯ",
    fiction: "เขียวแล้วนะ คุณข้ามก่อนได้เลย ผมตามหลังคุณอยู่ เดี๋ยวผมข้ามตามไป แต่ถ้าคุณรีบไปก่อน ผมก็ไม่ว่าอะไรหรอกนะ ผมแค่รอให้ไฟเขียวอีกครั้งก็เท่านั้นเอง :)",
    mood: "ISOLATION"
  },
  {
    id: 14,
    title: "แมวแปลกหน้า",
    subtitle: "สวัสดีครับ มนุษย์แปลกหน้า",
    location: "ถนนเพชรบุรี กรุงเทพฯ",
    date: "02.02.2026",
    image: "/img/18.jpg", 
    fact: "ถนนเพชรบุรี กรุงเทพฯ",
    fiction: "มนุษย์นี่แปลกนะ บางครั้งก็รีบเร่ง บางครั้งก็ช้า บางครั้งก็ดูเหมือนจะไม่สนใจอะไรเลย แต่บางครั้งก็ดูเหมือนจะสนใจทุกอย่างรอบตัว ฉันแค่แมวตัวหนึ่งที่เดินผ่านไปมาในชีวิตของมนุษย์เหล่านี้ และฉันก็ไม่เข้าใจว่าทำไมพวกเขาถึงดูยุ่งเหยิงกันจังเลย",
    mood: "ISOLATION"
  },
  {
    id: 15,
    title: "ดอกไม้กลางกรุง",
    subtitle: "ดอกไม้มีชื่อไหมมมม?",
    location: "ถนนเพชรบุรี กรุงเทพฯ",
    date: "02.02.2026",
    image: "/img/19.jpg", 
    fact: "ถนนเพชรบุรี กรุงเทพฯ",
    fiction: "ฉันเติบโตบนพื้นปูน ฉันเติบโตบนทางเท้า ฉันเติบโตท่ามกลางมลพิษและเสียงรถราที่ไม่เคยหยุดพัก แต่ฉันยังคงผลิบานอย่างสวยงามในทุกๆ วัน เสียงสะอื้นของผู้คน เสียงเท้าผู้คนที่เดินกลับจากทำงานหนัก เสียงแตรรถที่ดังไม่หยุด ทั้งหมดนั้นคือ ปุ๋ย ที่ทำให้ฉันเบ่งบาน",
    mood: "ISOLATION"
  },
  {
    id: 16,
    title: "รีบหน่อยมนุษย์",
    subtitle: "ช้าไปผมไม่รอแล้วนะ",
    location: "ถนนเพชรบุรี กรุงเทพฯ",
    date: "02.02 .2026",
    image: "/img/20.jpg", 
    fact: "ถนนเพชรบุรี กรุงเทพฯ",
    fiction: "คุณช้าไปแล้วนะ รีบขึ้นอีกหน่อยดีไหม ผมรู้ว่ายิ่งช้ายิ่งปลอดภัย แต่บางทีเมฆฝนก็มาไว บางทีลมหนาวก็มาเร็ว รีบอีกหน่อยนะมนุษย์ เหนื่อยหน่อย แต่อาจจะทันวินมอเตอร์ไซต์ก็ได้นะ",
    mood: "ISOLATION"
  },
  {
    id: 17,
    title: "ตลาดหลังเลิกเหงา",
    subtitle: "แวะมาซื้อของกิน แวะมาเติมความเหงา",
    location: "ถนนเพชรบุรี กรุงเทพฯ",
    date: "02.02.2026",
    image: "/img/21.jpg", 
    fact: "ถนนเพชรบุรี กรุงเทพฯ",
    fiction: "ร้านไหนก็มีของขายเหมือนกันหมด แต่ทำไมบางร้านถึงดูคึกคัก บางร้านถึงดูเงียบเหงา บางทีคนที่มาเดินตลาด อาจจะไม่ได้มาแค่ซื้อของกิน แต่เขาอาจจะมาเติมเต็มความเหงาที่ขาดหายไปในแต่ละวันก็ได้",
    mood: "ISOLATION"
  },
  {
    id: 18,
    title: "ใกล้ถึงห้องแล้วนะ",
    subtitle: "ไม่เหนื่อยเลย จนถึงห้องถึงรู้ว่าเหนื่อยนะ",
    location: "ถนนเพชรบุรี กรุงเทพฯ",
    date: "02.02 .2026",
    image: "/img/22.jpg", 
    fact: "ถนนเพชรบุรี กรุงเทพฯ",
    fiction: "บรรยากาศรอบๆ เริ่มเงียบลงแล้ว ใกล้ถึงที่ของเราแล้ว เดินอีกนิดเดียว วันนี้ร่างกายอาจจะทวงคืนบางอย่าง ในระหว่างวันก็ไม่ได้เหนื่อยอะไรนะ แต่พอถึงห้องนี่สิ เหนื่อยมากเลยแหละ แต่พอตกกลางคืน ฉันไม่ได้ต้องการที่จะนอนเลย ในตอนกลางคืน ฉันง่วงฉันเหนื่อยมาก แต่ฉันไม่อยากนอนเลย บางทีอาจจะไม่ใช่เพราะเป็นคนนอนดึก แต่ร่างกายอาจจะกำลังงอแงและทวงชีวิตคืนให้อยู่ ขอเวลาอีกนิดเพื่อฟังเพลง ขอเวลาอีกนิดเพื่อพูดคุย",
    mood: "ISOLATION"
  },
];
